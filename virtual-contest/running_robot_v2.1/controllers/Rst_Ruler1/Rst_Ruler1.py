...
#import urllib2
# 全局变量定义
MAP_block= [1, 0, 5, 3, 4, 2]
MAP_block_direc= [1, 1, 0, 0, 0, -1]
MAP_block_type1= [2, 4, 1]
MAP_block_type11= [2, 4, 1]
# 方块定义：
BLOCK_START = -1
...
class runningrobot_env:
    ...
    def Random_setLevel(self):
        ...
        Race_direc[0] = 1
        ##############################地板顺序
        #block = self.random_order()  # 关卡顺序和方向
        block = MAP_block
        block_direc = MAP_block_direc
        ...
        ########################################小关卡顺序
        block_type1 = MAP_block_type1
        print("block_type1=",block_type1)
        sublevel[1] = block_type1[0]
        sublevel[4] = block_type1[1]
        #block_type11 = [BLOCK_SECOND, BLOCK_THIRD, BLOCK_FORTH]  # 地雷,球,挡板所允许的方块：
        block_type11 = MAP_block_type11
        print("block_type11=",block_type11)
