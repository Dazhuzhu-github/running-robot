...
py_ver = 'python' + str(sys.version[0]) + str(sys.version[2])

# ${WEBOTS_HOME}/projects/robots/robotis/darwin-op/libraries
libraryPath = os.path.join(os.environ.get("WEBOTS_HOME"), 'projects', 'robots', 'robotis', 'darwin-op', 'libraries', py_ver)
